...
const TutorMovesScreen = ({ parsedMoves, movesData, damageClasses }) => {

    const tutorMoves = parsedMoves.filter((move) => move.learnMethod === 'tutor');

    const tutorMovesData = tutorMoves.map((move) => {
    ...
    const sortedMovesData = tutorMovesData.sort((a, b) => a.level - b.level);
