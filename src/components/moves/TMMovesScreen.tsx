...
const TMMovesScreen = ({ parsedMoves, movesData, damageClasses }) => {

    const tmMoves = parsedMoves.filter((move) => move.learnMethod === 'machine');

    const tmMovesData = tmMoves.map((move) => {
    ...
    const sortedMovesData = tmMovesData.sort((a, b) => a.level - b.level);
