...
const EggMovesScreen = ({ parsedMoves, movesData, damageClasses }) => {

    const eggMoves = parsedMoves.filter((move) => move.learnMethod === 'egg');

    const eggMovesData = eggMoves.map((move) => {
    ...
    const sortedMovesData = eggMovesData.sort((a, b) => a.level - b.level);
